...
#     model = Question
#     template_name = 'landing_page/results.html'
...
#         return render(request, 'landing_page/detail.html', {
#             'question': question,
...
#         return HttpResponseRedirect(reverse('landing_page:results', args=(question.id,)))
